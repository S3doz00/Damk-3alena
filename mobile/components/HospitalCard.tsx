...
import { Facility } from "@/context/AppContext";
import UrgencyBadge from "./UrgencyBadge";

interface Props {
  hospital: Facility;
  onPress: (h: Facility) => void;
}
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.distWrap}>
          ...
          <Text style={styles.hours}>{hospital.workingHours}</Text>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        <View style={styles.footerItem}>
          ...
          <Text style={styles.footerText}>{hospital.city}, Jordan</Text>
        </View>

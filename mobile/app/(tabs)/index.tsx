  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20 }}>
        ...
        <TouchableOpacity
          style={{ width: 46, height: 46, borderRadius: 14, backgroundColor: colors.card, alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.07, shadowRadius: 8, elevation: 3, borderWidth: 1, borderColor: isDark ? "rgba(51,65,85,0.8)" : "rgba(255,255,255,0.9)" }}
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20, marginBottom: 4 }}>
        <Text style={{ fontSize: 11, fontWeight: "700", color: colors.textMuted, letterSpacing: 0.8, marginBottom: 10 }}>{t('upcomingAppt')}</Text>
      </View>
      ...
      <View style={{ paddingHorizontal: 20, marginBottom: 4 }}>
        <Text style={{ fontSize: 11, fontWeight: "700", color: colors.textMuted, letterSpacing: 0.8, marginBottom: 10 }}>{t('donationEligibility')}</Text>
      </View>
      ...
      {profile?.bloodType && (
        <>
          <View style={{ paddingHorizontal: 20, marginBottom: 4 }}>
            <Text style={{ fontSize: 11, fontWeight: "700", color: colors.textMuted, letterSpacing: 0.8, marginBottom: 10 }}>{t('yourBloodType')}</Text>
          </View>
          <View style={{ paddingHorizontal: 20, marginBottom: 24 }}>
            <LinearGradient
              colors={glassColors}
        ...
        <>
          <View style={{ paddingHorizontal: 20, marginBottom: 10 }}>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
              <Text style={{ fontSize: 11, fontWeight: "700", color: colors.textMuted, letterSpacing: 0.8 }}>{t('criticalNeeds')}</Text>
              <TouchableOpacity onPress={() => router.push("/(tabs)/urgent")}>
                <Text style={{ fontSize: 13, fontWeight: "600", color: colors.primary }}>{t('seeAll')}</Text>
              </TouchableOpacity>
            </View>
          </View>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      <Text style={{ fontSize: 14, fontWeight: "600", color: colors.text, marginBottom: 2 }} numberOfLines={1}>{n.facility.name}</Text>
                      <Text style={{ fontSize: 12, color: colors.textSecondary }}>{n.facility.city}</Text>
                    </View>

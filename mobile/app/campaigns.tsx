...
const makeStyles = (colors: typeof Colors.light) => StyleSheet.create({
  ...
  card: { backgroundColor: colors.card, borderRadius: 16, padding: 20, marginBottom: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 10, elevation: 4 },
  ...
  cardHospital: { fontSize: 14, color: colors.textSecondary, marginBottom: 14 },
  ...
  btChipText: { fontSize: 13, fontWeight: "700", color: colors.primary },
  progressWrap: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 16 },
  progressBg: { flex: 1, height: 8, backgroundColor: colors.separator, borderRadius: 4, overflow: "hidden" },
  ...
  registerBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: colors.primary, borderRadius: 12, paddingVertical: 13, gap: 8 },
